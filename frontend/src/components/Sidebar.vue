    ...
    <div class="mt-auto pb-2">
      ...
      >
        <Avatar
          ...
          shape="circle"
        />
        <span class="font-bold">Walter White</span>
      </a>
    </div>
      ...
      <ul class="list-none p-4 m-0">
        <li>
          <RouterLink
            to="/dashboard"
            v-ripple
            class="flex items-center cursor-pointer p-4 gap-x-2 rounded text-surface-700 hover:bg-surface-100 dark:text-surface-0 dark:hover:bg-surface-800 duration-150 transition-colors p-ripple"
          >
        ...
        <li>
          ...
          >
            <i class="pi pi-home mr-2"></i>
            <span class="font-medium">Dashboard Create</span>
          </RouterLink>
        </li>
        ...
        <li>
          ...
          >
            <i class="pi pi-home mr-2"></i>
            <span class="font-medium">Dashboard Update</span>
          </RouterLink>
        </li>
